        ...
        <div class="container">
            ...
            <div class="d-flex">
                <div class="nav-item active">
                    <div class="nav-item">
                        <a class="nav-link active" href="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['en', 'id' => $card['id']])}}">
                    <span class="sr-only">
                        EN
                    </span>
                        </a>
                    ...
                    <div class="nav-item">
                        <a class="nav-link active" href="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), ['ru', 'id' => $card['id']]) }}">
                    <span class="sr-only">
                        RU
                    </span>
                        </a>
