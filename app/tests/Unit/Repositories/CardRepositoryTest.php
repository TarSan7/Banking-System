...
class CardRepositoryTest extends TestCase
{
     ...
     * @var CardRepository
     */
    private $cardRepository, $general;
    ...
    public function setUp(): void
    {
        ...
        $this->general = $this->cardRepository->create([
            'type' => 'checking',
    ...
    {
        $this->assertCount(7, $this->cardRepository->all());
    }
